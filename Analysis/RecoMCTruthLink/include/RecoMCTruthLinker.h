...
/** Optionally creates four collections of LCRelations ("recoMCTruthLink", "trackMCTruthLink", "mcTruthTrackLink",
 "clusterMCTruthLink",
 ...
 *                                corresponding MCParticle - the weight is the fraction of all hits on the the track
 that have contributions from this MCParticle
 *  <li><b>mcTruthTrackLink</b>:  holds LCRelations  that map MCParticles to tracks - the weight is the fraction of all
 sim-hits from the MCParticle that contributed to this track
 ...
 * @param UseTrackerHitRelations          use the rel collection for TrackerHits default true (false only for very old
 files)
 ...
 * @param KeepDaughtersPDG              absolute PDG code of particles where daughter are to be kept (default:
 gamma,pi0,K0_S)
 ...
 *          changelog F.Gaede, 02/2012  modified logic for optional output collections (collection name not empty) and
 added mcTruthTrackLink
 *  @version $Id$
 */
...
public:
  ...
  virtual void trackLinker(LCEvent* evt, LCCollection* mcpCol, LCCollection* trackCol, LCCollection** ttrcol,
                           LCCollection** trtcol);
  virtual void clusterLinker(LCEvent* evt, LCCollection* mcpCol, LCCollection* clusterCol, LCCollection** ctrcol,
                             LCCollection** trccol, LCCollection** chittrlcol);
  virtual void particleLinker(LCCollection* mcpCol, LCCollection* particleCol, LCCollection* ttrcol,
                              LCCollection* ctrlcol, LCCollection* trtlcol, LCCollection* trclcol,
                              LCCollection** ptrlcol, LCCollection** trplcol);
  virtual void linkPrinter(LCCollection* mcpCol, LCCollection* particleCol, LCCollection* ptrlcol,
