...
Int_t LowMomentumMuPiSeparationPID_BDTG::MuPiSeparation(TLorentzVector pp, EVENT::Track* trk,
...
Float_t LowMomentumMuPiSeparationPID_BDTG::getMVAOutput() { return mvaout; }

bool LowMomentumMuPiSeparationPID_BDTG::isValid() { return _isValid; }

LowMomentumMuPiSeparationPID_BDTG::~LowMomentumMuPiSeparationPID_BDTG() { delete reader; }
