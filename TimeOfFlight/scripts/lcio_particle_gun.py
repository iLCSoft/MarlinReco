...
if len( sys.argv ) != 4:
   print "usage: python lcio_particle_gun.py particle_type momentum polar_angle"
   exit(0)

#---- read input parameters 
particle_type=sys.argv[1]
#------ one of 'muon','pion','kaon'

momentum=sys.argv[2]

polar_angle=sys.argv[3]
...
momenta = [ float(momentum) ]
theta = float(polar_angle)/180. * math.pi 
...
outfile = "mcparticles_"+particle_type+"_"+momentum+"GeV_"+polar_angle+"deg.slcio"
...
run.setRunNumber( 0 ) 
run.setDetectorName("ILD_l4_v02")
