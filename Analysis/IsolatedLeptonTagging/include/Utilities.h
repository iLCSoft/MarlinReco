...
// MCParticle* getLinkedMCParticle(ReconstructedParticle *recPart, LCCollection *colMCTL, Double_t &weight, Int_t
// &nMCTL);
...
// void getConeEnergy(ReconstructedParticle *recPart, LCCollection *colPFO, Double_t cosCone, Bool_t woFSR, TVector3
// coneEnergy0);
...
void getConeEnergy(ReconstructedParticle* recPart, LCCollection* colPFO, Double_t cosCone, Bool_t woFSR,
                   Double_t coneEnergy[3], Double_t pFSR[4], Double_t conCone2, Double_t pCone2[4], Int_t& nConePhoton);
...
Int_t getVertexComponents(LCCollection* colMC, LCCollection* colMCTL, ReconstructedParticle* vetex,
