...
RecoParticle getLinkedPFO( const MCP &mcParticle , const LCRelationNavigator &RecoMCParticleNav , const LCRelationNavigator &MCParticleRecoNav , const bool &getChargedPFO , const bool &getNeutralPFO , float &weightPFOtoMCP , float &weightMCPtoPFO , bool &foundlinkedPFO )
{
