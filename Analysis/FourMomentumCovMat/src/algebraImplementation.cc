...
// ====================================================================
int getCovMatrixMomenta(ReconstructedParticle const* par, TMatrixD& covMatrixMomenta)
...
//
{
  ...
  Double_t jacobian_by_columns[rows * columns] = {0,
                                                  -track_px / track_omega,
                                                  -track_py,
                                                  0,
                                                  -track_py / track_omega,
                                                  track_px,
                                                  track_pt,
                                                  -track_pz / track_omega,
                                                  0,
  ...
  Double_t helix_cov_matrix_by_columns[rows * rows] = {cov44, cov42, cov41, cov42, cov22, cov21, cov41, cov21, cov11};

  TMatrixD covMatrix_helix(rows, rows, helix_cov_matrix_by_columns, "F");

  covMatrixMomenta.Mult(TMatrixD(jacobian, TMatrixD::kTransposeMult, covMatrix_helix), jacobian);
