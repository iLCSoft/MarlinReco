...
public:
  ...
  static float getDistanceTo(const std::vector<int>& vectorPoint1, const std::vector<float>& vector1,
  ...
  static float getDistanceBtw(const double* vectorPoint1, std::vector<float>& vectorDirection1,
                              const double* vectorPoint2, std::vector<float>& vectorDirection2);
