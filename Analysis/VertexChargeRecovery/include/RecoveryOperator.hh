...
public:
  ...
  std::vector<EVENT::ReconstructedParticle*>* getVertexParticles(EVENT::LCCollection* secvtx,
                                                                 std::vector<EVENT::Vertex*>* tagged);
  std::vector<EVENT::ReconstructedParticle*> getTrackParticles(EVENT::LCCollection* secvtx,
                                                               std::vector<EVENT::ReconstructedParticle*>* particles);
  std::vector<EVENT::ReconstructedParticle*> getPFOParticles();
  bool IsMinimalAngle(EVENT::ReconstructedParticle* candidate, EVENT::Vertex* chosen,
                      std::vector<EVENT::Vertex*>* vertices);

  std::vector<EVENT::Vertex*> RecoverJetVertices(EVENT::LCCollection* jetcol, EVENT::LCCollection* jetrelcol,
                                                 EVENT::LCCollection* secvtx, EVENT::LCCollection* damagedcol = NULL,
                                                 EVENT::LCCollection* newjetrelcol = NULL);
  ...
  AddParticles(const std::vector<EVENT::ReconstructedParticle*>& pri, EVENT::Vertex* sec,
               ...
               std::vector<EVENT::Vertex*>* allVtx = NULL);
