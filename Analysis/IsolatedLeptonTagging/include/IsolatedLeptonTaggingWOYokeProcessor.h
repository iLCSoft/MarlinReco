#ifndef IsolatedLeptonTaggingWOYokeProcessor_h
#define IsolatedLeptonTaggingWOYokeProcessor_h 1
 ...
 * @version $Id: IsolatedLeptonTaggingWOYokeProcessor.h,v 1.0 2013-10-31 12:57:39 Junping Exp $ 
 */

class IsolatedLeptonTaggingWOYokeProcessor : public marlin::Processor {
  
 public:
  
  virtual marlin::Processor*  newProcessor() { return new IsolatedLeptonTaggingWOYokeProcessor ; }
  
  
  IsolatedLeptonTaggingWOYokeProcessor() ;
 ...
 protected:
  ...
  Float_t _ratioecal{}, _ratiototcal{}, _nsigd0{}, _nsigz0{}, _totalcalenergy{};
