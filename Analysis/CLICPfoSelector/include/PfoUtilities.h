...
#define FORMATTED_OUTPUT_TRACK_CLUSTER_full(out, N1, E1, E2, E3, N2, E4, N3, E5, E6, E7)                               \
  out << std::right << std::setw(widthInt) << N1 << std::right << std::setw(widthFloat) << E1 << std::right            \
      ...
      << std::setw(widthFloat) << E5 << std::right << std::setw(widthFloat) << E6 << std::right                        \
      << std::setw(widthFloat) << E7 << std::endl

#define FORMATTED_OUTPUT_TRACK_CLUSTER(out, N1, E1, E2, E3, N2, N3)                                                    \
  out << std::right << std::setw(widthInt) << N1 << std::right << std::setw(widthFloat) << E1 << std::right            \
      << std::setw(widthFloat) << E2 << std::right << std::setw(widthFloat) << E3 << std::right                        \
      << std::setw(widthSmallInt) << N2 << std::right << std::setw(widthSmallInt) << N3 << std::endl
