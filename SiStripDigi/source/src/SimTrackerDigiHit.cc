...
//
void SimTrackerDigiHit::setPosition(double pos[3]) { setPrePosition(pos[0], pos[1], pos[2]); }
...
// Set posStep position of a hit
//
void SimTrackerDigiHit::set3PosPosition(const Hep3Vector& posPosition) { _posPosition = posPosition; }
