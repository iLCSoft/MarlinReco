...
struct HitState {
  // Struct which contains a combination of the simulated, reconstructed tracker hit and the track state of the track at
  // this reconstructed hit position
...
// iterative Kalman Filter (IKF) returns the track length and square root of the harmonic momentum mean of the squared
// momentum.
