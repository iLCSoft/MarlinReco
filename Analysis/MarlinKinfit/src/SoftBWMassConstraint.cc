...
bool SoftBWMassConstraint::secondDerivatives (int i, int j, double *derivatives) const 
{
...
bool SoftBWMassConstraint::firstDerivatives (int i, double *derivatives) const {
  double totE = 0;
  double totpx = 0; 
  double totpy = 0; 
  double totpz = 0; 
