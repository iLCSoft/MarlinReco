...
std::vector<std::string> InputAlgorithm_Pandora::init(const std::vector<float>& inparF,
...
std::vector<std::pair<float, float>> InputAlgorithm_Pandora::extractObservables(ReconstructedParticleImpl* pfo,
                                                                                LCCollection*, int) {
