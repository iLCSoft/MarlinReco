...
public:
   ...
   Bool_t GetEnergyDensity(const Int_t& rLayer, const Double_t& rRadius, 
                                const Double_t& rPhi, Double_t* pEnDens,
...
private:
   ...
   void Destroy();
   Int_t GetCellNumber(const Int_t& rLayer, const Double_t& rRadius, 
                                const Double_t& rPhi) const;

   Bool_t MakeInterpolation ( const Double_t& rX, const vector<Double_t>& rXData, 
