...
std::vector<std::string> InputAlgorithm_dEdx::init(const std::vector<float>& inparF,
...
std::vector<std::pair<float, float>> InputAlgorithm_dEdx::extractObservables(ReconstructedParticleImpl* pfo,
                                                                             LCCollection*, int) {
