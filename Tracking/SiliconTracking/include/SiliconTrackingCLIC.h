#ifndef SILICONTRACKINGCLIC_H
#define SILICONTRACKINGCLIC_H 1
 ...
 */
class SiliconTrackingCLIC : public Processor {
  
 public:
  
  virtual Processor*  newProcessor() { return new SiliconTrackingCLIC ; }
 ...
 protected:
  ...
  //MB Added vectors for larger combination of Tracks
  TrackExtendedVec _tracks12Hits;
  TrackExtendedVec _tracks11Hits;
  TrackExtendedVec _tracks10Hits;
  TrackExtendedVec _tracks9Hits;
  TrackExtendedVec _tracks8Hits;
  TrackExtendedVec _tracks7Hits; 
  TrackExtendedVec _tracks6Hits;
