...
namespace TTbarAnalysis 
{
	...
	const std::vector<int> & ConstantStorage::TAU_LEPTON_PDG()
	{
		return myTauLeptonPDGs;
	}
	const std::vector<int> & ConstantStorage::CHARMED_MESONS_PDG()
	{
		return myCharmedMesonsPDGs;
	}
	const std::vector<int> & ConstantStorage::STRANGE_MESONS_PDG()
	{
		return myStrangeMesonsPDGs;
	}
	const std::vector<int> & ConstantStorage::BOTTOM_MESONS_PDG()
	{
		return myBottomMesonsPDGs;
	}
	const std::vector<int> & ConstantStorage::BOTTOM_BARYONS_PDG()
	{
		return myBottomBaryonsPDGs;
	}
	const std::vector<int> & ConstantStorage::BOTTOM_HADRONS_PDG()
	{
		return myBottomHadronsPDGs;
	}
	const std::vector<int> & ConstantStorage::CHARMED_BARYONS_PDG()
	{
		return myCharmedBaryonsPDGs;
	}
	const std::vector<int> & ConstantStorage::CHARMED_HADRONS_PDG()
	{
		return myCharmedHadronsPDGs;
	}
	const std::vector<int> & ConstantStorage::TRACKABLE_PARTICLES_PDG()
	{
		return myTrackableParticlesPDGs;
	}
	const std::vector<int> & ConstantStorage::NONTRACKABLE_PARTICLES_PDG()
	{
