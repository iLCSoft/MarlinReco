...
SimDigitalToEnergy::SimDigitalToEnergy() : RealisticCaloReco::Processor("SimDigitalToEnergy") {
  ...
  registerProcessorParameter("EnergyCalibration", "Threshold to Energy correspondace", _energyCoefficients,
                             energyCoefficients);
}
