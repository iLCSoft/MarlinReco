...
public:
  ...
  double* getRelativeConfusion(double jetEnergy, double chargedHadronsEnergy, double photonsEnergy,
                               double neutralHadronsEnergy, double relConfTerms[]);
...
protected:
  ...
  double p_semiLepSigmaCorrFactor{}; /* A correction factor to be multiplied by total lepton energy to get semi-leptonic
                                        uncertainty */
  double p_CovMatFactorPhotons{};    /* A correction factor to be multiplied to angular uncertainties of photons */
  double p_CovMatFactorNeutralHadrons{}; /* A correction factor to be multiplied to angular uncertainties of Neutral
                                            Hadrons */
