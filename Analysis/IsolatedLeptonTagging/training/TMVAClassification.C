...
void TMVAClassification( TString myMethodList = "" ) 
{
   ...
   factory->AddVariable( "coneec",      'coneec');
   factory->AddVariable( "coneen",      'coneen');
   //   factory->AddVariable( "coneenergy",      'coneenergy');
   factory->AddVariable( "momentum",      'momentum');
   factory->AddVariable( "coslarcon",     'coslarcon');
   factory->AddVariable( "energyratio",   'energyratio');
   //   factory->AddVariable( "momentumcor",      'momentumcor');
#if 1
   //   factory->AddVariable( "ecalenergy",      'ecalcalenergy');
   //   factory->AddVariable( "hcalenergy",      'hcalcalenergy');
   factory->AddVariable( "yokeenergy",      'yokeenergy');
   factory->AddVariable( "nsigd0",      'nsigd0');
#if 1
   factory->AddVariable( "nsigz0",      'nsigz0');
#else
   //   factory->AddVariable( "(z0-zipmc)/z0*nsigz0",      'nsigz0');
   factory->AddVariable( "(z0-zipvf)/z0*nsigz0",      'nsigz0');   
#endif   
   factory->AddVariable( "totalcalenergy",      'totalcalenergy');
#endif
...
#if 0
   factory->AddSpectator( "spec1:=econe1",   "Spectator 1", "units", 'F' );
   factory->AddSpectator( "spec2:=econec1",  "Spectator 2", "units", 'F' );
   factory->AddSpectator( "spec3:=pthrust",  "Spectator 3", "units", 'F' );
   factory->AddSpectator( "spec4:=yminus",   "Spectator 4", "units", 'F' );
#endif
   ...
   if (ReadDataFromAsciiIFormat) {
     ...
     //      TFile *fsignal = new TFile("../ZHllX_500/yyxylv_part1000_l_500.root");
     //      TFile *fbackground = new TFile("../ZHllX_500/yycyyc_l_500.root");
      TFile *fsignal = new TFile("../root_merge/yyxylv.eL.pR.mILD_l5_o1_v02.root");     
      TFile *fbackground = new TFile("../root_merge/yycyyc.eL.pR.mILD_l5_o1_v02.root");
      TFile *fbackground1 = new TFile("../root_merge/yycyyc.eR.pL.mILD_l5_o1_v02.root");
      TFile *fbackground2 = new TFile("../root_merge/yycyyu.eL.pR.mILD_l5_o1_v02.root");
      TFile *fbackground3 = new TFile("../root_merge/yycyyu.eR.pL.mILD_l5_o1_v02.root");
      TFile *fbackground4 = new TFile("../root_merge/yyuyyc.eL.pR.mILD_l5_o1_v02.root");
      TFile *fbackground5 = new TFile("../root_merge/yyuyyc.eR.pL.mILD_l5_o1_v02.root");
      TFile *fbackground6 = new TFile("../root_merge/yyuyyu.eL.pR.mILD_l5_o1_v02.root");
      TFile *fbackground7 = new TFile("../root_merge/yyuyyu.eR.pL.mILD_l5_o1_v02.root");
      TNtupleD *signal = fsignal->Get("hPfo");
      TNtupleD *background = fbackground->Get("hPfo");
      TNtupleD *background1 = fbackground1->Get("hPfo");
      TNtupleD *background2 = fbackground2->Get("hPfo");
      TNtupleD *background3 = fbackground3->Get("hPfo");
      TNtupleD *background4 = fbackground4->Get("hPfo");
      TNtupleD *background5 = fbackground5->Get("hPfo");
      TNtupleD *background6 = fbackground6->Get("hPfo");
      TNtupleD *background7 = fbackground7->Get("hPfo");
	...
	exit(1);
      ...
      //      Double_t backgroundWeight1= 0.5;
      Double_t backgroundWeight1= 1.0;
      Double_t backgroundWeight2= 0.5;
      Double_t backgroundWeight3= 1.0;
   ...
   //   TCut mycut  = "charge!=0&&abs(coscone-0.90)<0.001";
   TCut mycut1  = "charge!=0&&momentum>5";
   TCut mycut2  = "totalcalenergy/momentum<0.3";
   //   TCut mycut3  = "ecalenergy/(totalcalenergy+0.0000000001)<0.5";
   TCut mycut3  = "yokeenergy>1.2";
   //   TCut mycut4  = "nsigd0 < 5 && nsigz0 < 5";
   TCut mycut4  = "abs(nsigd0) < 20 && abs(nsigz0) < 20";   
   //   TCut mycut4  = "nsigd0 < 5 && (z0-zipmc)/z0*nsigz0 < 5";   
   TCut mycut   = mycut1 + mycut2 + mycut3 + mycut4;
   //   TCut mycuts  = "mcpdg==13&&(mcoriginal==-24||(motherpdg==13&&mmotherpdg==11))";
   TCut mycuts  = "";   
   TCut mycutb  = "";
   //   TCut mycut = "ecaltot>0.9 && totmom>0.8 && totmom<1.2 && icos>0.994 && icos<0.996";
   // tell the factory to use all remaining events in the trees after training for testing:
   factory->PrepareTrainingAndTestTree( mycut+mycuts, mycut+mycutb,
   //   factory->PrepareTrainingAndTestTree( mycut, mycut,
					...
					"nTrain_Signal=100000:nTrain_Background=80000:SplitMode=Random:NormMode=NumEvents:!V" );					
