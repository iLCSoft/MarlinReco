...
protected:
  ...
  double _prodThreshOnDeltaRays; //!< Production threshold cut on delta electrons in keV (for Landau fluct.) - use the
                                 //!< same as in Geant4 (80keV ~ 0.05 mm)
  ...
  double _startIntegration; //!< Start time of integration of the sensors in ns (everything before this value will not
                            //!< be digitized)
  double _stopIntegration;  //!< Stop time of integration of the sensors in ns(everything after this value will not be
                            //!< digitized)
