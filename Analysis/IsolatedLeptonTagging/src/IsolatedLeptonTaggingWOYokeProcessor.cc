...
// *****************************************************
#include "IsolatedLeptonTaggingWOYokeProcessor.h"
...
IsolatedLeptonTaggingWOYokeProcessor aIsolatedLeptonTaggingWOYokeProcessor ;


IsolatedLeptonTaggingWOYokeProcessor::IsolatedLeptonTaggingWOYokeProcessor() : Processor("IsolatedLeptonTaggingWOYokeProcessor") {
  
  // modify processor description
  _description = "IsolatedLeptonTaggingWOYokeProcessor does whatever it does ..." ;
...
void IsolatedLeptonTaggingWOYokeProcessor::init() { 

  streamlog_out(DEBUG) << "IsolatedLeptonTaggingWOYoke   init called  " 
		       << std::endl ;
...
void IsolatedLeptonTaggingWOYokeProcessor::processRunHeader( LCRunHeader*  /*run*/) { 
} 

void IsolatedLeptonTaggingWOYokeProcessor::processEvent( LCEvent * evt ) { 
...
void IsolatedLeptonTaggingWOYokeProcessor::check( LCEvent *  /*evt*/ ) { 
}


void IsolatedLeptonTaggingWOYokeProcessor::end(){ 
