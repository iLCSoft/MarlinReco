...
KIT::KIT() : Processor("KIT") {
  ...
  registerProcessorParameter("ECAL_Collection", "Name of the CalorimeterHit Collection for ECAL ", _Ecal_col,
                             std::string("ECAL"));

  registerProcessorParameter("Core_Collection", "Name of the Cluster Collection for Cores ", _CoreCollection,
                             std::string("CORE"));
...
void KIT::processRunHeader(LCRunHeader* /*run*/) { _nRun++; }
